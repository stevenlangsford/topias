...
function reasonListener(areason){
    ...
    $.post("writeresponse",{time: Date.now(), value: JSON.stringify(trials[trialindex])})
    // $.post('/writeresponse',{myresponse:JSON.stringify(trials[trialindex])},function(success){
